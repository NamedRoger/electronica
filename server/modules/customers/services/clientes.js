...
const addCliente = (id_customer, {register_key, id_category, presentative, 
    tel_customer, cel_customer, email, note, address, city, state, country, 
    razon_social, rfc, bank, bank_key, price_number, business, tel_business, cel_business}) => {
        
    const query = `INSERT INTO customers (id_customer, register_key, id_category, presentative, 
        tel_customer, cel_customer, email, note, address, city, state, country, 
        razon_social, rfc, bank, bank_key, price_number, business, tel_business, cel_business) VALUES ('${id_customer}', '${register_key}',
